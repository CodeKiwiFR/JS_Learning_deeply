...
class ProjectItem {
    ...
    connectDrag() {
        ...
        // Just to test this possibility
        // NB: look at the event, the dataTransfer.dropEffect is different if drop succeded or not
...
class ProjectList {
    ...
    connectDropable() {
        ...
        list.addEventListener("drop", (event) => {
            ...
            const projectFinishButton = document
            ...
            if (!this.projects.find((proj) => proj.id === projectId)) {
                projectFinishButton.click();
                event.preventDefault();
            }
            destination.parentElement.classList.remove("droppable");
        });
    }
